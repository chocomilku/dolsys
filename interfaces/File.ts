...
/**
 * File interface that has category details but without the ID and path.
 */
export interface FileMetadata extends Omit<FileWithCategory, "path" | "user_id"> {}

/**
 * File interface that omits unneccesary attributes for file uploads.
 */
export interface FileUpload extends Omit<File, "id" | "created_at" | "download_count" | "uid"> {}

/**
 * File interface that attacges the unique ID of the file generated by the `nanoid` package.
 */
...
/**
 * File interface that omits crucial attributes for file uploads.
 */
